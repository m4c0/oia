...
def AgentExample()
  echo Agent([
    ...
    list_files: fns.Fn("List files in a given directory. The tool don't recurse and it only works with directories. Result is empty if directory does not exist.", {
